...
var BookStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Failed: ".concat(err_1));
    ...
    BookStore.prototype.create = function (b) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, book, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO books (title, author, totalpages, summary) "
                            + "VALUES ($1, $2, $3, $4)";
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Failed: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Failed: ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    BookStore.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, book, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Failed: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
